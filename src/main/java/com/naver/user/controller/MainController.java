...
public class MainController {
    ...
    @GetMapping("/main")
    public ModelAndView showMain(@RequestParam(value = "keyword", required = false) String keyword,HttpSession session){
...
//         투두 리스트 가져다 줘야하고
        ...
        } else modelAndView.addObject("todolist", todoService.findAll());
        return modelAndView;
